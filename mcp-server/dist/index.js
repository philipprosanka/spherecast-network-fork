    ...
    () => {
      const stats = {
        ...
        raw_materials: db
          ...
          .get().n,
        suppliers: db.prepare('SELECT COUNT(*) AS n FROM Supplier').get().n,
        facilities: db
          .prepare('SELECT COUNT(*) AS n FROM SupplierFacility')
          .get().n,
        supplier_product_links: db
          .prepare('SELECT COUNT(*) AS n FROM Supplier_Product')
          .get().n,
        bills_of_materials: db.prepare('SELECT COUNT(*) AS n FROM BOM').get().n,
        ingredient_profiles: db
          .prepare('SELECT COUNT(*) AS n FROM IngredientProfile')
          .get().n,
        fda_standards: db.prepare('SELECT COUNT(*) AS n FROM FdaStandard').get()
          .n,
      }
